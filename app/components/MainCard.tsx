      ...
      <div className={cn("flex w-full flex-col items-center -translate-x-2 justify-evenly", lightsOffClass)}>
        <h1
          className={cn(
            ...
            "font-bold text-primary hover:text-white justify-start text-left",
        ...
        <p className="flex w-full select-none flex-col items-center justify-center text-center text-secondary text-sm sm:text-lg">
        ...
        <hr className="hidden sm:block border-t border-t-secondary/80 opacity-60 -ml-5 w-full" />
        <SocialLinks />
        <span className="h-[2rem] sm:h-[1.8rem]"></span>
      </div>
      <Nav />
    </Card>
  );
