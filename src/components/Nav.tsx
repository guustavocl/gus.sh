...
const Nav = () => {
  return (
    <div className="flex select-none flex-row justify-center gap-1.5 text-center font-mono text-sm text-pink-200 text-glow-violet-500/70 md:justify-start md:text-left md:text-base">
